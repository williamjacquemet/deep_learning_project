...
# -*- coding: utf-8 -*-
"""
Created on Sat May 11 12:13:12 2019
...
""" part to take the data and put it in vectors
...
for i in range(1,max_range):
    try:
        file_name = os.path.join('../Train',str(i)+'.wav')
...
model.fit(g, ytrain,batch_size=100, nb_epoch=300, verbose=1, validation_split=0.09)
